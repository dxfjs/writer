...
export default class Entity extends DXFManager {
    ...
    get subclassMarker(): string {
        return this._subclass_marker;
    }
    get type(): string {
        return this._type;
    }
    ...
    private trueColorTag = () => {
        if (isNaN(DXFManager.currentTrueColor)) return [];
        return this.makeStandard([[420, DXFManager.currentTrueColor]]);
    };
