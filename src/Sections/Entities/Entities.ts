...
export default class Entities implements DxfInterface {
	...
	private readonly _blockRecordHandle: string | null;

	public get blockRecordHandle(): string | null {
		return this._blockRecordHandle;
	}

	public constructor(blockRecordHandle: string | null) {
		this._blockRecordHandle = blockRecordHandle;
	}

	public addEntity(entity: Entity) {
		entity.softPointer = this.blockRecordHandle;
