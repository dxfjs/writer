...
{
    get fitPoints     () : number[][] { return this._fit_points;      }
    get weights       () : number[]   { return this._weights;         }
    get knots         () : number[]   { return this._knots;           }
    get flag          () : number     { return this._flag;            }
    get curveDegree   () : number     { return this._curve_degree;    }
    get controlPoints () : number[][] { return this._control_points;  }
    ...
    public constructor(
        control_points : number[][]      , fit_points : number[][]  = [],
        curve_degree   : number     = 3  , flag       : SplineFlags = SplineFlags.Planar,
    ...
    )
    {
        ...
        if (this._knots.length !== knotsLength) {
            throw new Error(`Invalid knot vector length. Expected ${knotsLength} but received ${this._knots.length}.`);
        }
    }
