...
{
    get end_parameter()     : number    { return this._end_parameter;      }
    get start_parameter()   : number    { return this._start_parameter;    }
    get ratio_minor_axis()  : number    { return this._ratio_minor_axis;   }
    get y_major_axis()      : number    { return this._y_major_axis;       }
    get x_major_axis()      : number    { return this._x_major_axis;       }
