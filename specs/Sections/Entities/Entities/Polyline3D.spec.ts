import Polyline3D from "../../../../src/Sections/Entities/Entities/Polyline3D";
...
describe('Polyline3D', () => {
    ...
    it('should return the given parameters.', () => {
        const entity = new Polyline3D([[121.326,0.4152,8787], [120, 5544,45]], 0);
        dataState.instancesCount++;
        expect(entity.flag).toBe(0);
        expect(entity.points).toEqual([[121.326,0.4152,8787], [120, 5544,45]]);
    });
